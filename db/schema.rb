...
ActiveRecord::Schema.define(version: 20230313004340) do
  ...
  create_table "budget_investments", force: :cascade do |t|
    ...
    t.integer  "ballot_offline_count",                        default: 0
    t.string   "size"
  end
...
# Could not dump table "colonia" because of following StandardError
#   Unknown type 'geometry(MultiPolygon)' for column 'the_geom'
  ...
  create_table "decide_fest", id: false, force: :cascade do |t|
    t.integer "id"
    t.integer "votos"
  end
  ...
  add_index "users", ["curp"], name: "index_users_on_curp", using: :btree
  ...
  create_table "usuarios_no", id: false, force: :cascade do |t|
    t.integer "id"
  end
