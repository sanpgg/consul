  ...
  ################################action controller########################
#  config.action_controller.default_url_options = { host: '172.16.100.231', port: nil,  protocol: 'http'}
  config.action_controller.default_url_options = { host: 'localhost', port: nil,  protocol: 'https'}
  ...
  config.paperclip_defaults = {
      ...
      s3_credentials: {
        ...
        s3_host_name: 's3.us-east-2.domain.com',
        s3_options: {
