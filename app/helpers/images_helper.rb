module ImagesHelper
  ...
  def render_destroy_image_link(builder, image)
    ...
    if !image.persisted? && image.cached_attachment.present?
      ...
      #link_to_remove_association "Borrar", builder, class: "delete remove-image"
      link_to t('images.form.delete_button'), additional_image_path(image), method: :delete, class: "delete remove-image"
    end
  end
